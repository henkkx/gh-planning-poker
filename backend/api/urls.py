...
from .views import planning_poker_session_view, get_csrf, user_info_view, most_recent_session_view, logout_view


urlpatterns = [

    path('users/me', user_info_view, name='user_info_view'),
    path('users/logout', logout_view, name='logout_view'),
